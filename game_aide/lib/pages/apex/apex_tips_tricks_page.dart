...
import '/models/apex_models/apex_tips.dart';
import 'package:url_launcher/url_launcher.dart';

class ApexTipsTricksPage extends StatefulWidget {
  const ApexTipsTricksPage({Key? key}) : super(key: key);

  @override
  _ApexTipsTricksPageState createState() => _ApexTipsTricksPageState();
}

class _ApexTipsTricksPageState extends State<ApexTipsTricksPage> {
